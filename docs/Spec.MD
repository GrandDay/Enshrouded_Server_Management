...
> **Enshrouded Steam App ID:** `1203620`  
...
2. Run SteamCMD with `+force_install_dir`, `+login anonymous`, `+app_update 1203620 validate`, `+quit`
...
3. Run SteamCMD `+app_update 1203620 validate` to pull any available update
